...
class _UserProfileScreenState extends ConsumerState<UserProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: selfProfileData == null ?  Container(
        height: context.heightPx * 0.5,
        child: Center(child:  SpinKitThreeBounce(color: primaryColor,))) : SingleChildScrollView(
        child: Container(
            ...
            children: [
              ...
              Center(
                child: Image.asset(
                  ...
                  width: (selfProfileData.data?.isPremium ?? false) ? 60 : 120,
                  fit: BoxFit.fill,
                ),
              ),
              12.vGap,
              ...
              Visibility(
                visible:
                    selfProfileData?.data?.isPremium == true ? false : true,
                child: InkWell(
                  onTap: () {
                    showDialog(
                        context: context,
              ...
              Visibility(
                  visible:
                      selfProfileData?.data?.isPremium == true ? true : false,
                  child: Container(
                    height: 100,
                    child: Row(
              ...
              ClipRRect(
                ...
                child: Stack(
                  children: [
                    (selfProfileData?.data?.profileImages?.isNotEmpty ?? false)
                    ...
                    Positioned(
                      ...
                      child: Center(
                        child: Row(
                          ...
                          children: [
                            Text(
                              selfProfileData?.data?.name ?? '', // Safely access name
                              style: GoogleFonts.roboto(
                            ...
                            12.hGap,
                            Visibility(
                              visible: selfProfileData?.data?.showAge?.showAgeStatus != true, // Check if showAgeStatus is false
                              child: Text(
                                Utils.calculateAge(selfProfileData?.data?.birthdate ?? ''), // Safely access birthdate
                                style: GoogleFonts.roboto(
                    ...
                    Positioned(
                      ...
                      right: 6,
                      child: DotsIndicator(
                        dotsCount: (selfProfileData?.data?.profileImages?.isNotEmpty ?? false)
                            ? (selfProfileData?.data?.profileImages?.length ?? 0).clamp(1, double.infinity).toInt()
                            : 1, // Ensure dotsCount is at least 1
                        position: _currentIndex,
                        decorator: DotsDecorator(
                          activeColor: blackColor,
                          colors: List.filled(
                            selfProfileData?.data?.profileImages?.length ?? 0,
                            Colors.white,
                          ),
